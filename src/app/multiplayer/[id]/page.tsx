...
export default function MatchRoomPage() {
  ...
  console.info('[MatchRoomPage] reveal effect: state.names =', names);
  console.info('[MatchRoomPage] reveal effect: state.players =', state?.players);
  console.info('[MatchRoomPage] reveal effect: local playerId =', playerId);
  ...
  console.info('[MatchRoomPage] reveal effect: composed header/hpLine/result', { header, hpLine, result });
  ...
  function winnerLine() {
    ...
    const names: Record<string, string> = state?.names ?? {};
  console.info('[MatchRoomPage] winnerLine: state.names =', names, 'state.players =', players, 'playerId =', playerId);
